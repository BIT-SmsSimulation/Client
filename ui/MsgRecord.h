...
public:
    ...
    void setupUi(QDialog *MsgRecord)
    {
        ...
        listWidget->setGeometry(QRect(0, 0, 290, 180));
        ...
        listWidget_2->setGeometry(QRect(0, 0, 290, 180));
        ...
        listWidget_3->setGeometry(QRect(0, 0, 290, 180));
        ...
        listWidget_4->setGeometry(QRect(0, 0, 290, 180));
